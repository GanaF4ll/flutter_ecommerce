...
// in flutter_ecommerce/test/repositories/cart_repository_comprehensive_test.dart.
// Do not manually edit this file.

// ignore_for_file: no_leading_underscores_for_library_prefixes
import 'dart:async' as _i3;

import 'package:flutter_ecommerce/entities/cart_item.dart' as _i5;
...
class MockCartRepositoryInterface extends _i1.Mock
    implements _i4.CartRepositoryInterface {
  MockCartRepositoryInterface() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i3.Future<int> addToCart(
    int? productId,
    int? quantity,
  ) =>
      (super.noSuchMethod(
  ...
  @override
  _i3.Future<List<_i5.CartItem>> getCartItems() => (super.noSuchMethod(
        Invocation.method(
          #getCartItems,
          [],
        ),
  ...
  @override
  _i3.Future<_i5.CartItem?> getCartItemByProductId(int? productId) =>
      (super.noSuchMethod(
        Invocation.method(
          #getCartItemByProductId,
          [productId],
        ),
        returnValue: _i3.Future<_i5.CartItem?>.value(),
      ) as _i3.Future<_i5.CartItem?>);

  @override
  _i3.Future<int> updateCartItemQuantity(
    int? cartItemId,
    int? newQuantity,
  ) =>
      (super.noSuchMethod(
  ...
  @override
  _i3.Future<int> removeFromCart(int? cartItemId) => (super.noSuchMethod(
        Invocation.method(
          #removeFromCart,
          [cartItemId],
        ),
  ...
  @override
  _i3.Future<int> clearCart() => (super.noSuchMethod(
        Invocation.method(
          #clearCart,
          [],
        ),
  ...
  @override
  _i3.Future<int> getCartItemCount() => (super.noSuchMethod(
        Invocation.method(
          #getCartItemCount,
          [],
        ),
